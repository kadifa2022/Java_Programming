package day32_finalKeyword.Car_methodeOverriding;
...
public class Tesla extends Car{
    ...
    public void setModel(String model) {
        ArrayList<String> models = new ArrayList<>();//created ArrayList
        ...
        super.setModel(model); // this.model = model;-deleted this.model ad replaced with the setMethode(model) to exist object
    }
