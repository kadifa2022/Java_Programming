...
public class LocalDateIntro {
    ...
    public static void main(String[] args) {
        ...
        LocalDate today = LocalDate.now(); //2022-6-16//current methode

        System.out.println(today);

        LocalDate birthDay = LocalDate.of(1999, 2, 28);// you can put manually  time and dates
        ...
        graduationDate = graduationDate.plusMonths(7);//assign back
        ...
        LocalDate birthday1 = LocalDate.of(1994, 7, 7);//for the same years
