...
public class MapPractice3 {
    public static void main(String[] args) {//storing in Array
        ...
        person5.put("married", true);
                  ...
                  //array map//array size is fixed
        Map<String , Object> [] arrayOfMap = new Map[5];//index 1~4
        arrayOfMap[0]=person1;
        arrayOfMap[1]=person2;
        arrayOfMap[2]=person3;
        arrayOfMap[3]=person4;
        arrayOfMap[4]=person5;
       // arrayOfMap[5]=person6;size of array is fixed can't add
