...
public class TestObjects {
    ...
    public static void main(String[] args) {//create
        ...
        Student[] students = {student2, student3, student4, student5};//added to array list//object create


        StudentsGroup group1 = new StudentsGroup("Java Turtles", 1);//name grou


        group1.addStudent(student1);

        //group1.addStudent(students);  check this one

        group1.addStudent("Khashayar", 34, 'M', "F35");

        System.out.println(group1);

        group1.removeStudent("D43");//to remove
        group1.removeStudent("E27");

        System.out.println(group1);


        for (Student each : group1.students) {//to print
            System.out.println(each.name + " : " + each.id);
        }

        System.out.println("------------------------------------------");

        StudentsGroup group2 = new StudentsGroup("Java Turtles", 1);//create 3 more groups
        ...
        StudentsGroup[] groups = {group1, group2, group3, group4};//add to array list
