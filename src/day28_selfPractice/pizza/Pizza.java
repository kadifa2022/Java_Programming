...
public class Pizza {
    ...
    public void setSize(String size) {
        if (!size.equalsIgnoreCase("Small") && size.equalsIgnoreCase("Medium") && size.equalsIgnoreCase("Large")) {
            System.err.println("Not valid pizza");
            System.exit(1);
        }
        this.size = size;
    }
    ...
    public void setNumberOfCheeseTopping(int numberOfCheeseTopping){
        ...
        if (numberOfCheeseTopping <= 0) {
            System.err.println("Invalid entry. Minimum number is 1");
            System.exit(1);
        }
        if (size.equalsIgnoreCase("Small") && numberOfCheeseTopping > 3) {
            System.err.println("Invalid entry: Maximum number of cheese is 3");
            System.exit(1);

        } else if (size.equalsIgnoreCase("Medium") && numberOfCheeseTopping > 4) {
            System.err.println("Invalid entry: Maximum number of cheese is 4");
            System.exit(1);
        }else if (size.equalsIgnoreCase("Large") && numberOfCheeseTopping >5){
            System.err.println("Invalid entry: Maximum number of cheese is 5");
            System.exit(1);
        }
    ...
    public void setNumberOfPepperoniTopping(int numberOfPepperoniTopping){
        ...
        if (size.equalsIgnoreCase("Small") && numberOfPepperoniTopping > 4){
            System.err.println("Invalid entry: Maximum number of pepperoni topping is 4 ");
            System.exit(1);
        }
        else if(size.equalsIgnoreCase("Medium") && numberOfPepperoniTopping > 5){
            System.err.println("Invalid entry: Maximum number of pepperoni is 5");
            System.exit(1);
        }
        else if(size.equalsIgnoreCase("Large") && numberOfPepperoniTopping > 6){
            System.err.println("Invalid entry: Maximum number of peperoni topping is 6");
            System.exit(1);
        }
