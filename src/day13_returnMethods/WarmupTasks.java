...
public class WarmupTasks {
    ...
    public static void main(String[] args) {
        ...
        calculate(200, 5, '/');//FIRST TASK-FOR CALCULATOR

        calculate(1, 100, '-');

/*
        Scanner input = new Scanner(System.in);//METHODE TROUGH SCANNER SWITCH
...
*/
    ...
    public static void ageGroup(int age){//CUSTOM METHOD

        if(age >=0  && age <= 150){//NESTED IF
    ...
    public static void eligibleToVote(int age, boolean isAmerican){//THIRD TASK
