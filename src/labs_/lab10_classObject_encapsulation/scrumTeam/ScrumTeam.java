package labs_.lab10_classObject_encapsulation.scrumTeam;
...
public class ScrumTeam { // ScrumTeam HAS A Tester
    ...
    public void addTester(Tester tester){//Calling methode
        testers.add(tester);
    }

    public void addTester(Tester[] testers){
        this.testers.addAll( Arrays.asList(testers) );//add to Arrays.list -addList
    }


    public void addDeveloper(Developer developer){//calling methode
        developers.add(developer);
    }

    public void addDeveloper(Developer[] developers){//
        this.developers.addAll( Arrays.asList(developers));//Add to Array list
    }


    public void removeTester(String id){
        testers.removeIf( p -> p.getId().equals(id) );//remove tester methode
    }

    public void removeDeveloper(String id){
        developers.removeIf( p -> p.getId().equals(id));//remove developer methode
    }


    public String toString() {//to string methode get all Except (Days of sprint0
        return "ScrumTeam{" +
                "PO='" + PO + '\'' +
                ", BA='" + BA + '\'' +
                ", SM='" + SM + '\'' +
