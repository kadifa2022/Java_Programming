...
public class Student {//instant variables
    ...
    public Student(String name, int age, char gender, char grade, String schoolName) {
        setName(name);//check the variables valid
        setAge(age);
        setGender(gender);
        setGrade(grade);
    ...
    public String getName(){ // READ ONLY///    Interview question
        /*
        if(name == null){
            name = "Unknown";
        }
    ...
    public void setName(String name){ // WRITE ONLY//   interview question
        /*
        if(name.isEmpty()){
    ...
    public void study(){
        System.out.println(name +" is studying at "+schoolName);//adding study methode
    }
