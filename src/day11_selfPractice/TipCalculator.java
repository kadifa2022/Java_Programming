...
public class TipCalculator {
    public static void main(String[] args) {
        ...
        if (yesOrNo.equals("yes")){
            ...
            System.out.println("Tip per person:" + (tipRate / numOfPeople));
...
Create a class called TipCalculator, and write a program for a tip calculator.
 ...
 split of the program should ask the user to enter:
  Poor =num5%, Fair = 10%, Good = 15%, Great = 20%, Excellent = 25%
 - Split or No split (Yes or No),
- Enter the number of people (number)
- Enter the check amount (number)
- Service Quality (String)
it should display: Number of people entered Total to pay
Total tip
Total per person
Tip per person:
Split or No split (Yes or No)? YeS
Enter the number of people
Enter the check amount:476

How was the service quality? (Excellent/Great/Good/Fair/Poor) ExCElLeNt
output:
Number of people entered:
4 Total to pay: 595.0
Total tip: 119.0
