...
public class MinimumNumber {
    ...
    public static void main(String[] args) {
        ...
        int min = 2147483647;//any number that user entered will be smaller than this number

        for (int i = 0; i < 5; i++) {
            System.out.println("Enter a number:");
            int num = input.nextInt();// 20, 30, -5, 100, 200

            if (num < min) {//if the user entered entry is grater than current minimum number that we hav
