...
public class RemoveIfMethodPractice {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Dog> smallDogs = new ArrayList<>( Arrays.asList(dogs) );
                                  ...
                                  //p is object (age, color, size and etc.)
        smallDogs.removeIf( p -> !p.size.equalsIgnoreCase("Small"));//if is true can be removed form Array list
...
*/
        ...
        System.out.println(smallDogs);
                               ...
                               //Array list convert inf collection type
...
//second option
        ...
        dogs2 = list.toArray(new Dog[list.size()]);//can be added [0]for new dog  and the list also
