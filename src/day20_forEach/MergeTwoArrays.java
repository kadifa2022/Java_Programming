...
//public class MergeTwoArrays { //int arr-in third arr-use new key word-size of the first arr + second
    //-size must be fixed-be all (zero by default)for third-first.length + second.length.//
    // (make sure to have capacity to contain//create k and arr.string-print
...
public class MergeTwoArrays {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------------------------------" );
        String[] str1={"kadifa ", "belma", " fata"};
        String[] str2={"lidie ", "Cupy ", "Ilfo"};

       String [] str3 = ArraysUtility.merge(str1,str2);//assign String
