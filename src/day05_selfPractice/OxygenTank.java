...
public class OxygenTank {
    ...
    public static void main(String[] args) {
        ...
        if (number < 60 && number >= 50){
            result = " Be Careful now tyou at 50%";
        }
...
/*
Create a class named OxygenTank. You are diving in the ocean. Your oxygen tank has a certain level (number) and you must print
